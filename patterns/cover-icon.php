...
<div class="wp-block-group mavi-cover-icon">
	...
	<div class="wp-block-cover is-dark mavi-cover-icon__image" style="min-height: 280px; padding: 0;">
	...
	<div class="wp-block-group mavi-cover-icon__emoji-wrapper" style="margin-top: -50px;">
		<!-- wp:paragraph {"style":{"typography":{"fontSize":"4.5rem","lineHeight":"1"}},"className":"mavi-cover-icon__emoji"} -->
		<p class="mavi-cover-icon__emoji" style="font-size: 4.5rem; line-height: 1;">🚀</p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
