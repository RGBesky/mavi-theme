...
<!-- wp:group {"style":{"border":{"radius":"8px","width":"1px","color":"var:preset|color|surface"},"spacing":{"padding":{"top":"0","bottom":"var:preset|spacing|30","left":"0","right":"0"}},"overflow":"hidden"},"layout":{"type":"constrained"},"className":"mavi-project-card"} -->
<div class="wp-block-group mavi-project-card" style="border: 1px solid var(--wp--preset--color--surface); border-radius: 8px; padding-top: 0; padding-right: 0; padding-bottom: var(--wp--preset--spacing--30); padding-left: 0; overflow: hidden;">
	...
	<div class="wp-block-group" style="padding-top: var(--wp--preset--spacing--30); padding-left: var(--wp--preset--spacing--30); padding-right: var(--wp--preset--spacing--30);">
		...
		<div class="wp-block-group" style="margin-top: var(--wp--preset--spacing--20);">
			<!-- wp:paragraph {"style":{"color":{"background":"var:preset|color|info-bg","text":"var:preset|color|accent"},"typography":{"fontSize":"0.75rem"},"spacing":{"padding":{"top":"2px","bottom":"2px","left":"8px","right":"8px"}},"border":{"radius":"6px"}},"className":"mavi-tag"} -->
			<p class="mavi-tag" style="border-radius: 6px; color: var(--wp--preset--color--accent); background-color: var(--wp--preset--color--info-bg); padding: 2px 8px; font-size: 0.75rem;">Flutter</p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"style":{"color":{"background":"var:preset|color|navy-bg","text":"var:preset|color|primary"},"typography":{"fontSize":"0.75rem"},"spacing":{"padding":{"top":"2px","bottom":"2px","left":"8px","right":"8px"}},"border":{"radius":"6px"}},"className":"mavi-tag"} -->
			<p class="mavi-tag" style="border-radius: 6px; color: var(--wp--preset--color--primary); background-color: var(--wp--preset--color--navy-bg); padding: 2px 8px; font-size: 0.75rem;">Dart</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
